...
The **Native exe version** is now the only version available as it has been proven to be stable and offer better performance than the PowerShell version! If you still use the PS version, upgrading is recommended!
___
